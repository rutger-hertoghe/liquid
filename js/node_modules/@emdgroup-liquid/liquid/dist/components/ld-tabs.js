...
let tabsCount = 0;
const LdTabs$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.ldtabchange = createEvent(this, "ldtabchange", 7);
  ...
  render() {
    return (h(Host, { onLdtabselect: this.handleLdtabselect, class: "ld-tabs" }, h("slot", null)));
  }
  get el() { return this; }
  static get style() { return ldTabsShadowCss; }
}, [1, "ld-tabs", {
    "switchTab": [64]
  }]);
function defineCustomElement$1() {
  ...
  const components = ["ld-tabs"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-tabs":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdTabs$1);
      }
      break;
  } });
}
...
const LdTabs = LdTabs$1;
const defineCustomElement = defineCustomElement$1;

export { LdTabs, defineCustomElement };
