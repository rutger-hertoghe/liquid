...
const LdProgress$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  static get style() { return ldProgressCss; }
}, [1, "ld-progress", {
    "ariaLabeledby": [513, "aria-labeledby"],
    "ariaValuemax": [514, "aria-valuemax"],
    "ariaValuemin": [514, "aria-valuemin"],
    "ariaValuenow": [514, "aria-valuenow"],
    "ariaValuetext": [513, "aria-valuetext"],
...
function defineCustomElement$1() {
  ...
  const components = ["ld-progress"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-progress":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdProgress$1);
      }
      break;
  } });
}
...
const LdProgress = LdProgress$1;
const defineCustomElement = defineCustomElement$1;

export { LdProgress, defineCustomElement };
