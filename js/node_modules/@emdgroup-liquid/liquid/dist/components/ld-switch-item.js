...
const LdSwitchItem$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.ldswitchitemchange = createEvent(this, "ldswitchitemchange", 7);
    this.ldswitchitemfocus = createEvent(this, "ldswitchitemfocus", 7);
  ...
  render() {
    ...
    return (h(Host, { onClick: this.handleClick, class: cl }, h("label", { part: "label-element" }, h("input", Object.assign({ type: "radio" }, this.clonedAttributes, { part: "input focusable", onKeyDown: this.handleKeyDown, onFocus: this.handleFocus, ref: (ref) => (this.input = ref), required: this.required, disabled: this.disabled, checked: this.checked, tabIndex: this.checked ? this.ldTabindex : -1 })), h("span", { part: "content", class: "ld-switch-item__content" }, h("slot", { name: "icon-start" }), h("span", { part: "label", class: "ld-switch-item__label" }, h("slot", null)), h("slot", { name: "icon-end" })))));
  }
  get el() { return this; }
  ...
  static get style() { return ldSwitchItemCss; }
}, [1, "ld-switch-item", {
    "ariaDisabled": [513, "aria-disabled"],
    "checked": [1028],
    "disabled": [4],
    "form": [1],
...
function defineCustomElement$1() {
  ...
  const components = ["ld-switch-item"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-switch-item":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdSwitchItem$1);
      }
      break;
  } });
}
...
const LdSwitchItem = LdSwitchItem$1;
const defineCustomElement = defineCustomElement$1;

export { LdSwitchItem, defineCustomElement };
