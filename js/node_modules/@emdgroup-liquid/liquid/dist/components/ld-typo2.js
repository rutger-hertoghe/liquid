...
const LdTypo = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  render() {
    ...
    return (h(HTag, Object.assign({}, this.clonedAttributes, { class: `ld-typo ld-typo--${this.variant}`, part: "tag", ref: (ref) => (this.root = ref) }), h("slot", null)));
  }
  get el() { return this; }
  static get style() { return ldTypoCss; }
}, [1, "ld-typo", {
    "tag": [1],
    "variant": [1025],
...
function defineCustomElement() {
  ...
  const components = ["ld-typo"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-typo":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdTypo);
      }
      break;
  } });
}
...
export { LdTypo as L, defineCustomElement as d };
