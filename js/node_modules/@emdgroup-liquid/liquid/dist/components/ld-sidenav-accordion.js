...
import { d as defineCustomElement$6 } from './ld-accordion2.js';
import { d as defineCustomElement$5 } from './ld-accordion-panel2.js';
import { d as defineCustomElement$4 } from './ld-accordion-section2.js';
import { d as defineCustomElement$3 } from './ld-accordion-toggle2.js';
...
const LdSidenavAccordion$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ldSidenavAccordionShadowCss; }
}, [1, "ld-sidenav-accordion", {
    "expanded": [1028],
    "preserveState": [4, "preserve-state"],
    "split": [4],
    "expandOnSidenavExpansion": [32],
    "inAccordion": [32],
    "noIcon": [32],
    "rounded": [32],
    "sidenavClosable": [32],
    "sidenavCollapsed": [32],
    "transitionsEnabled": [32]
  }, [[9, "ldSidenavBreakpointChange", "handleSidenavBreakpointChange"], [9, "ldSidenavSliderChange", "handleSidenavSliderChange"], [9, "ldSidenavCollapsedChange", "handleSidenavCollapsedChange"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["ld-sidenav-accordion", "ld-accordion", "ld-accordion-panel", "ld-accordion-section", "ld-accordion-toggle", "ld-icon"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-sidenav-accordion":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdSidenavAccordion$1);
      }
      break;
    case "ld-accordion":
      if (!customElements.get(tagName)) {
...
const LdSidenavAccordion = LdSidenavAccordion$1;
const defineCustomElement = defineCustomElement$1;

export { LdSidenavAccordion, defineCustomElement };
