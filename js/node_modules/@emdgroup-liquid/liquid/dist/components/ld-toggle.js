...
const LdToggle$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    return (h(Host, { class: getClassNames([
      ...
      ]), onClick: this.handleClick }, h("input", Object.assign({}, this.clonedAttributes, { "aria-disabled": this.ariaDisabled, checked: this.checked, disabled: this.disabled, onChange: this.handleChange, onInput: this.handleInput, part: "input focusable", ref: (ref) => (this.input = ref), required: this.required, tabIndex: this.ldTabindex, type: "checkbox", value: this.value })), h("span", { class: "ld-toggle__knob", part: "knob" }), this.hasIcons && (h("div", { class: "ld-toggle__icon-start", part: "icon-wrapper icon-wrapper-start" }, h("slot", { name: "icon-start" }))), this.hasIcons && (h("div", { class: "ld-toggle__icon-end", part: "icon-wrapper icon-wrapper-end" }, h("slot", { name: "icon-end" })))));
  }
  get el() { return this; }
  ...
  static get style() { return ldToggleCss; }
}, [1, "ld-toggle", {
...
function defineCustomElement$1() {
  ...
  const components = ["ld-toggle"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-toggle":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdToggle$1);
      }
      break;
  } });
}
...
const LdToggle = LdToggle$1;
const defineCustomElement = defineCustomElement$1;

export { LdToggle, defineCustomElement };
