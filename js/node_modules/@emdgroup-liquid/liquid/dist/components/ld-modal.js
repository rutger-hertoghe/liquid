...
const LdModal$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  render() {
    ...
    return (h(Host, { class: cl }, h("dialog", { onClick: this.handleClick, onClose: this.handleClose, onTransitionEnd: this.handleTransitionEnd, open: this.open, part: "dialog", ref: (el) => (this.dialogRef = el) }, h("header", { class: "ld-modal__header", part: "header" }, h("slot", { name: "header" }), this.cancelable && (h("button", { class: "ld-modal__x", "aria-label": "Dismiss", onClick: this.close.bind(this) }))), h("div", { class: "ld-modal__content", part: "content" }, h("slot", null)), h("footer", { class: "ld-modal__footer", part: "footer" }, h("slot", { name: "footer" })))));
  }
  get el() { return this; }
  static get watchers() { return {
    "open": ["onOpenChange"]
  }; }
  static get style() { return ldModalCss; }
}, [1, "ld-modal", {
    "cancelable": [4],
    "open": [1540],
    "blurryBackdrop": [4, "blurry-backdrop"],
    "showModal": [64],
    "close": [64]
...
function defineCustomElement$1() {
  ...
  const components = ["ld-modal"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-modal":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdModal$1);
      }
      break;
  } });
}
...
const LdModal = LdModal$1;
const defineCustomElement = defineCustomElement$1;

export { LdModal, defineCustomElement };
