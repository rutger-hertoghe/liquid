...
const LdInput$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    ...
    if (this.multiline) {
      ...
      return (h(Host, { class: cl, onClick: this.handleClick }, h("textarea", Object.assign({}, clonedAttributesWithoutType, { onChange: this.handleChange, onInput: this.handleInput, part: "input focusable", ref: (el) => (this.input = el), tabIndex: this.ldTabindex, value: this.value })), type === 'file' && (h("span", { class: "ld-input__placeholder", part: "placeholder" }, ((_a = this.input) === null || _a === void 0 ? void 0 : _a.value) || this.placeholder))));
    }
    return (h(Host, { class: cl, onClick: this.handleClick }, h("slot", { name: "start" }), h("input", Object.assign({}, this.clonedAttributes, { autocomplete: this.autocomplete, onChange: this.handleChange, onInput: this.handleInput, onKeyDown: this.handleKeyDown, part: "input focusable", ref: (el) => (this.input = el), tabIndex: this.ldTabindex, value: this.value || undefined })), this.type === 'file' && (h("span", { class: "ld-input__placeholder", part: "placeholder" }, ((_b = this.input) === null || _b === void 0 ? void 0 : _b.value) || this.placeholder)), h("slot", { name: "end" })));
  }
  get el() { return this; }
  static get watchers() { return {
    "dirname": ["updateHiddenInput"],
    "form": ["updateHiddenInput"],
    "name": ["updateHiddenInput"],
    "value": ["updateHiddenInput"],
    "size": ["updateIconAndButtonSize"]
  }; }
  static get style() { return ldInputCss; }
}, [1, "ld-input", {
    "accept": [1],
    "autocomplete": [1537],
    "autofocus": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["ld-input"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-input":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdInput$1);
      }
      break;
  } });
}
...
const LdInput = LdInput$1;
const defineCustomElement = defineCustomElement$1;

export { LdInput, defineCustomElement };
