...
const LdSwitch$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return ldSwitchCss; }
}, [1, "ld-switch", {
    "size": [1],
    ...
    "hasFocus": [32],
    "focusInner": [64]
  }, [[0, "ldswitchitemchange", "handleLdSwitchItemChange"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["ld-switch"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-switch":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdSwitch$1);
      }
      break;
  } });
}
...
const LdSwitch = LdSwitch$1;
const defineCustomElement = defineCustomElement$1;

export { LdSwitch, defineCustomElement };
