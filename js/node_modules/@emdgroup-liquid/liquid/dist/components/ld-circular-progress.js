...
const LdCircularProgress$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  render() {
    ...
    return (h(Host, { class: cl, role: "progressbar", style: Object.assign(Object.assign(Object.assign({}, (this.ariaValuemax !== undefined && {
      ...
      })) }, h("svg", { class: "ld-circular-progress__stroke", viewBox: "0 0 10 10" }, h("circle", { cx: "5", cy: "5", r: "5" }), h("circle", { cx: "5", cy: "5", r: "5" })), h("slot", null)));
  }
  static get style() { return ldCircularProgressCss; }
...
function defineCustomElement$1() {
  ...
  const components = ["ld-circular-progress"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-circular-progress":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdCircularProgress$1);
      }
      break;
  } });
}
...
const LdCircularProgress = LdCircularProgress$1;
const defineCustomElement = defineCustomElement$1;

export { LdCircularProgress, defineCustomElement };
