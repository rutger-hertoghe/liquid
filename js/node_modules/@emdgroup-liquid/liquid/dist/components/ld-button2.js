...
const LdButton = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  ...
  render() {
    ...
    return (h(Tag, Object.assign({}, this.clonedAttributes, { href: this.href, "aria-busy": hasProgress ? 'true' : undefined, "aria-disabled": this.disabled || this.el.getAttribute('aria-disabled') === 'true'
        ? 'true'
        : undefined, "aria-live": "polite", class: cl, disabled: this.disabled, part: "button focusable", ref: (el) => (this.button = el), rel: this.target === '_blank' ? 'noreferrer noopener' : undefined, tabIndex: this.ldTabindex, value: this.value }), h("slot", null), hasProgress && (h("span", { class: clProgress, part: "progress-bar", style: styleProgress }))));
  }
  get el() { return this; }
  static get style() { return ldButtonCss; }
}, [1, "ld-button", {
    "alignText": [1025, "align-text"],
    "autofocus": [516],
    ...
    "formtarget": [1],
    "href": [1],
    "justifyContent": [1025, "justify-content"],
...
function defineCustomElement() {
  ...
  const components = ["ld-button"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdButton);
      }
      break;
  } });
}
...
export { LdButton as L, defineCustomElement as d };
