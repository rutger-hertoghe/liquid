...
import { d as defineCustomElement$6 } from './ld-icon2.js';
...
const LdSidenavNavitem$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.ldSidenavNavitemTo = createEvent(this, "ldSidenavNavitemTo", 7);
    this.ldSidenavNavitemClick = createEvent(this, "ldSidenavNavitemClick", 7);
  ...
  render() {
    ...
    return (h(Tag, { part: "navitem focusable", class: cl, href: this.href, ref: (el) => (this.focusableElement = el), rel: this.target === '_blank' ? 'noreferrer noopener' : undefined, onClick: this.onClick, onKeyDown: this.onKeyDown, "aria-haspopup": hasPopup, tabIndex: this.ldTabindex }, h("div", { class: "ld-sidenav-navitem__bg", part: "bg" }, h("div", { class: "ld-sidenav-navitem__bg-left" }), h("div", { class: "ld-sidenav-navitem__bg-center" }), h("div", { class: "ld-sidenav-navitem__bg-right" })), h("div", { class: "ld-sidenav-navitem__dot", part: "dot" }), h("div", { class: "ld-sidenav-navitem__slot-container-icon", role: "presentation", part: "slot-container-icon" }, h("slot", { name: "icon" }), this.abbreviation && (h("span", { class: "ld-sidenav-navitem__abbr", part: "abbreviation" }, this.abbreviation)), h("ld-tooltip", { arrow: true, size: "sm", class: "ld-sidenav-navitem__tooltip", disabled: !this.sidenavCollapsed, ref: (el) => (this.tooltipRef = el), "show-delay": "250", onMouseEnter: this.updateTooltipIcon, position: this.sidenavAlignement === 'left' ? 'right middle' : 'left middle', tag: "span" }, h("div", { class: "ld-sidenav-navitem__tooltip-trigger", slot: "trigger" }), h("div", { class: this.themeClass, style: {
        display: 'grid',
        gridAutoFlow: 'column',
        alignItems: 'center',
      } }, h("ld-typo", null, this.tooltipContent), this.to ? (h("ld-icon", { style: tooltipIconStyle, name: "real-arrow" })) : (this.secondaryIconHTML && (h("span", { style: tooltipIconStyle, innerHTML: this.secondaryIconHTML })))))), h("div", { class: "ld-sidenav-navitem__slot-container", part: "slot-container", ref: (el) => (this.slotContainerRef = el) }, h("slot", null)), h("div", { class: "ld-sidenav-navitem__slot-icon-secondary-container" }, this.to ? (h("ld-icon", { class: "ld-sidenav-navitem__icon-to", name: "real-arrow" })) : (h("slot", { name: "icon-secondary" })))));
  }
  get el() { return this; }
  static get style() { return ldSidenavNavitemShadowCss; }
}, [1, "ld-sidenav-navitem", {
    "selected": [4],
    "href": [1],
    "mode": [1],
    "rounded": [516],
...
function defineCustomElement$1() {
  ...
  const components = ["ld-sidenav-navitem", "ld-icon", "ld-sr-only", "ld-tooltip", "ld-tooltip-popper", "ld-typo"];
