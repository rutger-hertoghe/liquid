...
import { i as isInnerFocusable } from './focus.js';
...
const LdTablist$1 = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  render() {
    return (h(Host, { onClick: this.onClick, onKeydown: this.onKeydown, onFocusout: this.onFocusout, role: "tablist" }, h("div", { class: getClassNames([
        'ld-tablist',
      ...
      ]), part: "wrapper" }, !this.isFloating() && (h("button", { "aria-disabled": this.scrollLeftEnabled ? undefined : 'true', class: "ld-tablist__btn-scroll ld-tablist__btn-scroll--left", hidden: !this.scrollable, onClick: this.scroll.bind(this, 'left'), part: "arrow arrow-left", ref: (el) => (this.btnScrollLeftRef = el), tabindex: "-1" }, h("svg", { fill: "none", height: "16", part: "arrow-icon arrow-icon-left", viewBox: "0 0 16 16", width: "16" }, h("title", null, "Scroll left"), h("path", { d: "M10 13L6 8L10 3", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })))), h("div", { class: "ld-tablist__scroll-container", onScroll: this.updateScrollButtons.bind(this), part: "scroll-container", ref: (el) => (this.slotContainerRef = el) }, h("slot", null), this.isFloating() && (h("div", { part: "active-tab-indicator", class: "ld-tablist__active-tab-indicator", ref: (el) => (this.selectedTabIndicatorRef = el) }))), !this.isFloating() && (h("button", { "aria-disabled": this.scrollRightEnabled ? undefined : 'true', class: "ld-tablist__btn-scroll ld-tablist__btn-scroll--right", hidden: !this.scrollable, onClick: this.scroll.bind(this, 'right'), part: "arrow arrow-right", tabindex: "-1" }, h("svg", { fill: "none", height: "16", part: "arrow-icon arrow-icon-right", viewBox: "0 0 16 16", width: "16" }, h("title", null, "Scroll right"), h("path", { d: "M6 13L10 8L6 3", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })))))));
  }
  get el() { return this; }
  ...
  static get style() { return ldTablistShadowCss; }
}, [1, "ld-tablist", {
    "size": [1],
    "mode": [1],
    "rounded": [1],
    ...
    "selectedTab": [32],
    "scrollable": [32],
    "scrollLeftEnabled": [32],
    "scrollRightEnabled": [32],
    "focusVisible": [32],
    "selectedIsFocused": [32]
  }, [[0, "ldtabselect", "handleTabSelect"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["ld-tablist"];
  components.forEach(tagName => { switch (tagName) {
    case "ld-tablist":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, LdTablist$1);
      }
      break;
  } });
}
...
const LdTablist = LdTablist$1;
const defineCustomElement = defineCustomElement$1;

export { LdTablist, defineCustomElement };
