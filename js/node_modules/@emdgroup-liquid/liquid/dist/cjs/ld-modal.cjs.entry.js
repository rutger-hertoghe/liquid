...
const LdModal = class {
  constructor(hostRef) {
    ...
    this.ldmodalopening = index.createEvent(this, "ldmodalopening", 7);
    this.ldmodalopened = index.createEvent(this, "ldmodalopened", 7);
    this.ldmodalclosing = index.createEvent(this, "ldmodalclosing", 7);
    this.ldmodalclosed = index.createEvent(this, "ldmodalclosed", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, { class: cl }, index.h("dialog", { onClick: this.handleClick, onClose: this.handleClose, onTransitionEnd: this.handleTransitionEnd, open: this.open, part: "dialog", ref: (el) => (this.dialogRef = el) }, index.h("header", { class: "ld-modal__header", part: "header" }, index.h("slot", { name: "header" }), this.cancelable && (index.h("button", { class: "ld-modal__x", "aria-label": "Dismiss", onClick: this.close.bind(this) }))), index.h("div", { class: "ld-modal__content", part: "content" }, index.h("slot", null)), index.h("footer", { class: "ld-modal__footer", part: "footer" }, index.h("slot", { name: "footer" })))));
  }
...
LdModal.style = ldModalCss;

exports.ld_modal = LdModal;
