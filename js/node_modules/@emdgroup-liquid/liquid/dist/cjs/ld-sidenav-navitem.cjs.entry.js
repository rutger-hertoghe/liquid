...
const LdSidenavNavitem = class {
  ...
  handleSidenavCollapsedChange(ev) {
    ...
    toggleStackToTop.toggleStackToTop(this.el, this.sidenav.narrow && this.sidenavCollapsed);
  ...
  handleSidenavBreakpointChange(ev) {
    ...
    if (this.sidenavClosable) {
      toggleStackToTop.toggleStackToTop(this.el, false);
    }
    else {
      toggleStackToTop.toggleStackToTop(this.el, this.sidenav.narrow && this.sidenavCollapsed);
    }
  ...
  render() {
    ...
    return (index.h(Tag, { part: "navitem focusable", class: cl, href: this.href, ref: (el) => (this.focusableElement = el), rel: this.target === '_blank' ? 'noreferrer noopener' : undefined, onClick: this.onClick, onKeyDown: this.onKeyDown, "aria-haspopup": hasPopup, tabIndex: this.ldTabindex }, index.h("div", { class: "ld-sidenav-navitem__bg", part: "bg" }, index.h("div", { class: "ld-sidenav-navitem__bg-left" }), index.h("div", { class: "ld-sidenav-navitem__bg-center" }), index.h("div", { class: "ld-sidenav-navitem__bg-right" })), index.h("div", { class: "ld-sidenav-navitem__dot", part: "dot" }), index.h("div", { class: "ld-sidenav-navitem__slot-container-icon", role: "presentation", part: "slot-container-icon" }, index.h("slot", { name: "icon" }), this.abbreviation && (index.h("span", { class: "ld-sidenav-navitem__abbr", part: "abbreviation" }, this.abbreviation)), index.h("ld-tooltip", { arrow: true, size: "sm", class: "ld-sidenav-navitem__tooltip", disabled: !this.sidenavCollapsed, ref: (el) => (this.tooltipRef = el), "show-delay": "250", onMouseEnter: this.updateTooltipIcon, position: this.sidenavAlignement === 'left' ? 'right middle' : 'left middle', tag: "span" }, index.h("div", { class: "ld-sidenav-navitem__tooltip-trigger", slot: "trigger" }), index.h("div", { class: this.themeClass, style: {
        display: 'grid',
        gridAutoFlow: 'column',
        alignItems: 'center',
      } }, index.h("ld-typo", null, this.tooltipContent), this.to ? (index.h("ld-icon", { style: tooltipIconStyle, name: "real-arrow" })) : (this.secondaryIconHTML && (index.h("span", { style: tooltipIconStyle, innerHTML: this.secondaryIconHTML })))))), index.h("div", { class: "ld-sidenav-navitem__slot-container", part: "slot-container", ref: (el) => (this.slotContainerRef = el) }, index.h("slot", null)), index.h("div", { class: "ld-sidenav-navitem__slot-icon-secondary-container" }, this.to ? (index.h("ld-icon", { class: "ld-sidenav-navitem__icon-to", name: "real-arrow" })) : (index.h("slot", { name: "icon-secondary" })))));
  }
  get el() { return index.getElement(this); }
};
LdSidenavNavitem.style = ldSidenavNavitemShadowCss;

exports.ld_sidenav_navitem = LdSidenavNavitem;
