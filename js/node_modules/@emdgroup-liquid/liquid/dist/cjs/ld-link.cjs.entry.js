...
const LdLink = class {
  ...
  render() {
    ...
    return (index.h("a", Object.assign({}, this.clonedAttributes, { onClick: this.handleClick, class: cl, "aria-disabled": this.disabled || this.el.ariaDisabled ? 'true' : undefined, ref: (ref) => (this.anchor = ref), rel: this.target === '_blank' ? 'noreferrer noopener' : undefined, disabled: this.disabled, part: "anchor focusable", tabIndex: this.ldTabindex }), index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
LdLink.style = ldLinkCss;

exports.ld_link = LdLink;
