...
const LdSidenavScrollerInternal = class {
  constructor(hostRef) {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: cl, onScroll: this.updateShadows.bind(this), onLdSidenavAccordionTransitionEnd: this.updateShadows.bind(this), "data-needs-bottom": this.needsHRBottom, "data-needs-top": this.needsHRTop }, index.h("div", { class: "ld-sidenav-scroller-internal__shadow-top", style: { opacity: this.hasShadowTop ? '1' : '0' }, part: "shadow-top" }), index.h("div", { class: "ld-sidenav-scroller-internal__shadow-bottom", style: { opacity: this.hasShadowBottom ? '1' : '0' }, part: "shadow-bottom" }), this.needsHRTop && (index.h("ld-sidenav-separator", { class: "ld-sidenav-scroller-internal__hr-top", style: { opacity: this.hasShadowTop ? '0' : '1' } })), this.needsHRBottom && (index.h("ld-sidenav-separator", { class: "ld-sidenav-scroller-internal__hr-bottom", style: { opacity: this.hasShadowBottom ? '0' : '1' } })), index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
LdSidenavScrollerInternal.style = ldSidenavScrollerInternalShadowCss;
...
const LdSidenavSeparator = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
  ...
  handleSidenavCollapsedChange(ev) {
    ...
    if (this.sidenav.narrow) {
      toggleStackToTop.toggleStackToTop(this.el, this.sidenavCollapsed);
    }
  }
  handleSidenavBreakpointChange(ev) {
    if (ev.target !== this.sidenav)
  ...
  render() {
    ...
    return (index.h(index.Host, { style: {
      ...
      }, class: cl }, index.h("hr", { part: "hr" })));
  }
  get el() { return index.getElement(this); }
};
LdSidenavSeparator.style = ldSidenavSeparatorShadowCss;

exports.ld_sidenav_scroller_internal = LdSidenavScrollerInternal;
exports.ld_sidenav_separator = LdSidenavSeparator;
