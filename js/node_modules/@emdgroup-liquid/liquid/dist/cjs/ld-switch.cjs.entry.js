...
const LdSwitch = class {
  constructor(hostRef) {
    ...
    this.ldswitchchange = index.createEvent(this, "ldswitchchange", 7);
  ...
  render() {
    return (index.h(index.Host, { class: getClassNames.getClassNames([
        ...
        : this.hasFocus
          ? -1
          : this.ldTabindex || 0 }, index.h("fieldset", { part: "fieldset" }, this.legend && index.h("legend", { part: "legend" }, this.legend), index.h("slot", null))));
  }
