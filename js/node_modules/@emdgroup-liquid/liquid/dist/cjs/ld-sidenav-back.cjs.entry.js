...
const LdSidenavBack = class {
  ...
  render() {
    ...
    return (index.h("div", { tabIndex: this.parentLabel ? 0 : undefined, role: this.parentLabel ? 'button' : undefined, "aria-label": this.backLabel, class: cl, onClick: this.onClick, onKeyDown: this.onKeyDown, part: "back focusable" }, index.h("div", { class: "ld-sidenav-back__btn-back", part: "btn-back" }, index.h("div", { class: "ld-sidenav-back__bg", part: "bg" }, index.h("div", { class: "ld-sidenav-back__bg-left" }), index.h("div", { class: "ld-sidenav-back__bg-center" }), index.h("div", { class: "ld-sidenav-back__bg-right" })), index.h("div", { class: "ld-sidenav-back__icon", part: "icon-container" }, index.h("svg", { part: "icon", width: "12", height: "12", fill: "none" }, index.h("path", { d: "M4.333 1.832 1 5.999l3.333 4.166M1 6h10", stroke: "#F8F8FC", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }))), index.h("span", { class: "ld-sidenav-back__btn-back-label", part: "label" }, this.parentLabel)), index.h("div", { class: "ld-sidenav-back__slot-container", part: "slot-container" }, index.h("slot", null))));
  }
  get el() { return index.getElement(this); }
};
LdSidenavBack.style = ldSidenavBackShadowCss;

exports.ld_sidenav_back = LdSidenavBack;
