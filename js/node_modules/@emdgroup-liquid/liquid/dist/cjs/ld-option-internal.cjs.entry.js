...
const LdOptionInternal = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.ldoptionselect = index.createEvent(this, "ldoptionselect", 7);
    /**
  ...
  render() {
    return (index.h(index.Host, { class: getClassNames.getClassNames([
      ...
      ]) }, index.h("div", { class: getClassNames.getClassNames([
        'ld-option-internal',
        this.size && `ld-option-internal--${this.size}`,
      ]), role: "option", ref: (el) => (this.optionRef = el), "aria-selected": this.selected ? 'true' : undefined, "aria-disabled": this.disabled ? 'true' : undefined, onClick: this.handleClick.bind(this), onFocus: () => (this.hasFocus = true), onBlur: () => (this.hasFocus = false), onMouseOver: () => (this.hasHover = true), onMouseOut: () => (this.hasHover = false), tabindex: "-1", part: "option focusable" }, this.mode === 'checkbox' ? (index.h("div", { class: "ld-option-internal__checkbox-wrapper", role: "presentation", part: "checkbox-wrapper" }, index.h("ld-checkbox", { class: "ld-option-internal__checkbox", checked: this.selected, disabled: this.disabled, part: "checkbox" }))) : (index.h("svg", { role: 'presentation', class: "ld-option-internal__check", width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", part: "check" }, index.h("path", { style: { visibility: this.selected ? 'inherit' : 'hidden' }, d: "M15 7L8.40795 13L5 9.63964", stroke: "currentColor", "stroke-width": "3", "stroke-linecap": "round", "stroke-linejoin": "round" }))), index.h("span", { class: "ld-option-internal__label", title: this.title, part: "label" }, index.h("slot", null)))));
  }
  get el() { return index.getElement(this); }
};
LdOptionInternal.style = ldOptionInternalShadowCss;

exports.ld_option_internal = LdOptionInternal;
