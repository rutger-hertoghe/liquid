...
const LdCircularProgress = class {
  constructor(hostRef) {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: cl, role: "progressbar", style: Object.assign(Object.assign(Object.assign({}, (this.ariaValuemax !== undefined && {
      ...
      })) }, index.h("svg", { class: "ld-circular-progress__stroke", viewBox: "0 0 10 10" }, index.h("circle", { cx: "5", cy: "5", r: "5" }), index.h("circle", { cx: "5", cy: "5", r: "5" })), index.h("slot", null)));
  }
};
LdCircularProgress.style = ldCircularProgressCss;

exports.ld_circular_progress = LdCircularProgress;
