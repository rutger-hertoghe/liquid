...
const LdSelect = class {
  constructor(hostRef) {
    ...
    this.initPopper = () => {
      ...
      this.popper = new tether_esm.Tether(tetherOptions);
    ...
    this.handleFocusEvent = (ev) => {
      ...
      if (ev.relatedTarget === null ||
        ...
        closest.closest('ld-select', ev.relatedTarget) === this.el) {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h("div", { class: getClassNames.getClassNames(cl), "aria-disabled": this.disabled || this.ariaDisabled, part: "root", onBlur: this.handleFocusEvent, onFocusout: this.handleFocusEvent, style: this.expanded
        ...
        ? undefined
        : this.ldTabindex, "aria-disabled": this.disabled || this.ariaDisabled ? 'true' : 'false', "aria-haspopup": "listbox", "aria-expanded": this.expanded ? 'true' : 'false', "aria-label": triggerText, onClick: this.handleTriggerClick, ref: (el) => (this.triggerRef = el) }, this.multiple && this.selected.length ? (index.h("div", { class: "ld-select__selection-list-container", part: "selection-list-container" }, index.h("ul", { class: "ld-select__selection-list", part: "selection-list", "aria-label": "Selected options", ref: (el) => (this.selectionListRef = el), style: {
      ...
      return (index.h("li", { key: index$1, class: "ld-select__selection-list-item", style: { order: index$1 + 1 + '' }, part: "selection-list-item" }, index.h("label", { class: "ld-select__selection-label" }, index.h("span", { class: "ld-select__selection-label-text", title: selection.text, part: "selection-label-text" }, selection.text), index.h("button", { disabled: this.disabled || this.ariaDisabled
        ...
        } }, index.h("svg", { class: "ld-select__btn-clear-single-icon", part: "icon-clear-single", fill: "none", viewBox: "0 0 12 12" }, index.h("title", null, "Clear"), index.h("path", { stroke: "#fff", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M2 2l8 8M2 10l8-8" }))), index.h("span", { class: "ld-select__selection-label-bg", part: "selection-label-bg" }))));
    })))) : (index.h("span", { class: "ld-select__btn-trigger-text-wrapper", title: triggerText, part: "trigger-text-wrapper" }, index.h("span", { class: "ld-select__btn-trigger-text", part: "trigger-text" }, triggerText))), ((_b = this.selected) === null || _b === void 0 ? void 0 : _b.length) && this.multiple ? (index.h("button", { class: "ld-select__btn-clear", disabled: this.disabled || this.ariaDisabled ? true : undefined, onClick: this.handleClearClick, ref: (el) => (this.btnClearRef = el), part: "btn-clear focusable" }, index.h("svg", { class: "ld-select__btn-clear-icon", fill: "none", viewBox: "0 0 21 20", part: "icon-clear" }, index.h("title", null, "Clear all"), index.h("path", { fill: "currentColor", "fill-rule": "evenodd", d: "M10 20a10 10 0 100-20 10 10 0 000 20z", "clip-rule": "evenodd" }), index.h("path", { stroke: "#fff", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "2", d: "M6.67 6.67l6.67 6.66M6.67 13.33l6.67-6.66" })))) : (''), index.h("slot", { name: "icon" }), !this.hasCustomIcon && (
    /* custom icon arrow-down */
    index.h("svg", { class: getClassNames.getClassNames(triggerIconCl), role: 'presentation', viewBox: "0 0 16 16", part: "trigger-icon" }, index.h("path", { stroke: "currentColor", "stroke-linecap": "round", "stroke-linejoin": "round", "stroke-width": "3", d: "M3 6l5 4 5-4" }))))), index.h("ld-select-popper", { detached: detached, expanded: this.expanded, filter: this.filter, filterPlaceholder: this.filterPlaceholder, onBlur: this.handleFocusEvent, onFocusout: this.handleFocusEvent, onLdselectfilterchange: this.handleFilterChange, popperClass: this.popperClass, ref: (el) => (this.listboxRef = el), role: "listbox", size: this.size, theme: this.theme }, index.h("div", { ref: (el) => (this.internalOptionsContainerRef = el), innerHTML: this.internalOptionsHTML, part: "options-container" })))));
  }
