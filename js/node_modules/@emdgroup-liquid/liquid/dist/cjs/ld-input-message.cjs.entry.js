...
const LdInputMessage = class {
  ...
  render() {
    return (index.h(index.Host, { class: `ld-input-message ld-input-message--${this.mode}` }, index.h("ld-icon", { class: "ld-input-message__icon", name: 'ld-input-message-' + this.mode, part: "icon", size: "sm" }), index.h("span", { "aria-live": "assertive" }, index.h("slot", null))));
  }
  static get assetsDirs() { return ["assets"]; }
};
LdInputMessage.style = ldInputMessageCss;

exports.ld_input_message = LdInputMessage;
