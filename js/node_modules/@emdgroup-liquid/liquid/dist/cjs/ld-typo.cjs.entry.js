...
const LdTypo = class {
  ...
  componentWillLoad() {
    this.attributesObserver = cloneAttributes.cloneAttributes.call(this, ['tag', 'variant']);
  }
  componentDidRender() {
    this.applyAriaLabel();
  }
  ...
  render() {
    ...
    return (index.h(HTag, Object.assign({}, this.clonedAttributes, { class: `ld-typo ld-typo--${this.variant}`, part: "tag", ref: (ref) => (this.root = ref) }), index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
LdTypo.style = ldTypoCss;

exports.ld_typo = LdTypo;
