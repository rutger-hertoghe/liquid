...
const LdTooltip = class {
  ...
  render() {
    ...
    return (index.h(index.Host, null, index.h(TriggerTag, { "aria-describedby": this.idDescriber, class: getClassNames.getClassNames([
        'ld-tooltip__trigger',
...
LdTooltip.style = ldTooltipShadowCss;
...
const LdTooltipPopper = class {
  ...
  render() {
    return (index.h(index.Host, { class: getClassNames.getClassNames([
      ...
      ]), role: "tooltip" }, this.arrow && index.h("span", { class: "ld-tooltip__arrow" }), index.h("slot", null)));
  }
  get element() { return index.getElement(this); }
};
LdTooltipPopper.style = ldTooltipPopperShadowCss;

exports.ld_tooltip = LdTooltip;
exports.ld_tooltip_popper = LdTooltipPopper;
