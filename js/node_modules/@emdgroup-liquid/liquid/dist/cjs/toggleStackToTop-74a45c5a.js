...
const toggleStackToTop = (el, stacked) => {
  ...
  const sidenavPaddingY = parseInt(window
    .getComputedStyle(outerSlider)
    .getPropertyValue('--ld-sidenav-padding-y')) * 16;
...
exports.toggleStackToTop = toggleStackToTop;
