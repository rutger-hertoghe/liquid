...
const LdSidenav = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.ldSidenavCollapsedChange = index.createEvent(this, "ldSidenavCollapsedChange", 7);
    this.ldSidenavOpenChange = index.createEvent(this, "ldSidenavOpenChange", 7);
    this.ldSidenavBreakpointChange = index.createEvent(this, "ldSidenavBreakpointChange", 7);
    ...
    this.onTransitionEnd = (ev) => {
      if (ev.target === this.el) {
        ...
        if (this.fullyCollapsible) {
          if (!this.collapsed) {
            const firstFocusableInSidenav = focus.getFirstFocusable(this.el);
  ...
  handleKeyDown(ev) {
    ...
    if (hasSidenavFocus &&
      ...
      if (currentSubnav) {
        const firstItemOfCurrentSubnav = focus.getFirstFocusable(this.el.querySelector(`#${currentSubnav}`));
        setTimeout(async () => {
  ...
  async handleFocusout(ev) {
    ...
    const firstFocusableFromSelectorElements = trapFocusSelectorElements.find(focus.getFirstFocusable);
  ...
  render() {
    ...
    return (index.h(index.Host, { onTransitionEnd: this.onTransitionEnd, class: getClassNames.getClassNames(cl), role: "navigation", "aria-label": this.label }, index.h("slot", { name: "header" }), index.h("div", { class: "ld-sidenav__content" }, index.h("div", { class: "ld-sidenav__slot-container-top", part: "slot-container-top" }, index.h("slot", { name: "top" })), index.h("ld-sidenav-scroller-internal", { class: "ld-sidenav__scroller", part: "scroll-container" }, index.h("div", { class: "ld-sidenav__slot-container-default", part: "slot-container" }, index.h("slot", null))), index.h("div", { class: "ld-sidenav__slot-container-bottom", part: "slot-container-bottom" }, index.h("slot", { name: "bottom" }))), index.h("div", { onClick: this.toggle.bind(this), class: "ld-sidenav__fully-collapsed-click-area" })));
  }
...
LdSidenav.style = ldSidenavShadowCss;

exports.ld_sidenav = LdSidenav;
