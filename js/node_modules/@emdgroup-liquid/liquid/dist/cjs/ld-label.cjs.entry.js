...
const LdLabel = class {
  ...
  render() {
    ...
    return (index.h("label", Object.assign({}, this.clonedAttributes, { class: cl, onClick: this.handleClick, part: "tag" }), index.h("slot", null)));
  }
  get el() { return index.getElement(this); }
};
LdLabel.style = ldLabelCss;

exports.ld_label = LdLabel;
