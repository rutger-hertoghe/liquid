...
const LdSidenavAccordion = class {
  constructor(hostRef) {
    ...
    this.ldSidenavAccordionTransitionEnd = index.createEvent(this, "ldSidenavAccordionTransitionEnd", 7);
  ...
  render() {
    ...
    return (index.h(index.Host, { class: cl }, index.h("ld-accordion", { class: "ld-sidenav-accordion__accordion" }, index.h("ld-accordion-section", { expanded: this.expanded, ref: (el) => (this.sectionRef = el), class: "ld-sidenav-accordion__accordion-section" }, index.h("ld-accordion-toggle", { labelTag: "div", class: "ld-sidenav-accordion__accordion-toggle", split: this.split, "ld-tabindex": "-1" }, index.h("slot", { name: "toggle" })), index.h("ld-accordion-panel", { ref: (el) => (this.panelRef = el), onTransitionEnd: this.onTransitionEnd, class: "ld-sidenav-accordion__accordion-panel" }, index.h("slot", null))))));
  }
...
exports.ld_sidenav_accordion = LdSidenavAccordion;
