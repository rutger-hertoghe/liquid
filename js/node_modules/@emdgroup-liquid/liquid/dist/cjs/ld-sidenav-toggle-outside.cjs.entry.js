...
const LdSidenavToggleOutside = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { class: cl }, index.h("ld-tooltip", { arrow: true, size: "sm", ref: (el) => (this.tooltipRef = el), "show-delay": "1000", position: this.sidenavAlignement === 'left' ? 'right middle' : 'left middle', tag: "span" }, index.h("button", { slot: "trigger", role: "switch", "brand-color": true, "aria-checked": this.sidenavCollapsed ? 'false' : 'true', class: "ld-sidenav-toggle-outside__toggle", onClick: this.toggleSidenavCollapsedState, part: "toggle focusable", ref: (ref) => (this.toggle = ref), tabIndex: this.ldTabindex }, index.h("ld-icon", { class: "ld-sidenav-toggle-outside__icon", name: "sidenav-right", part: "toggle-icon" }), index.h("ld-sr-only", null, this.labelExpand)), index.h("ld-typo", null, this.labelExpand))));
  }
  get el() { return index.getElement(this); }
};
LdSidenavToggleOutside.style = ldSidenavToggleOutsideShadowCss;

exports.ld_sidenav_toggle_outside = LdSidenavToggleOutside;
