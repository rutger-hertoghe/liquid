import { r as registerInstance, c as createEvent, h, H as Host } from './index-51c17921.js';
...
const LdPagination = class {
  constructor(hostRef) {
    ...
    this.renderItem = (itemNumber, showFrom, showTo) => {
      ...
      return (h("li", { "aria-hidden": isHidden ? 'true' : undefined, class: getClassNames([
        ...
        ]), key: itemNumber, style: { '--ld-pagination-item-pos': `${itemNumber - 1}` } }, h("ld-button", { "aria-current": isSelected ? 'true' : undefined, "aria-label": isHidden ? undefined : `${this.itemLabel} ${itemNumber}`, class: isDots ? 'ld-pagination__dot' : undefined, "ld-tabindex": isHidden ? -1 : undefined, mode: "ghost", onClick: () => {
  ...
  render() {
    ...
    return (h(Host, { role: "navigation" }, h("ul", { "aria-label": "Pagination", class: getClassNames([
      ...
      ]), part: "wrapper", style: styleDots }, !this.hideStartEnd && (h("li", { class: "ld-pagination__arrow" }, h("ld-button", { "aria-label": this.startLabel
        ? undefined
      ...
      ]), part: "more-indicator" }, h("span", null, ". . ."))), h("li", { class: getClassNames([
