...
const LdBadge = class {
  ...
  render() {
    ...
    return (h(Host, { class: cl }, (this.icon || this.hasCustomIcon) && (h("ld-icon", { class: "ld-badge__icon", part: "icon", name: this.icon }, h("slot", { name: "icon" }))), h("slot", null)));
  }
