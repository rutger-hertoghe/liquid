      ...
      if (lastIndex === 0) {
        ...
        currentColorObject[namePart]['DEFAULT'] =
          colorTokenReferenceParts.length === 1
            ...
            : (_a = designTokens.colors[colorTokenReference]) !== null && _a !== void 0 ? _a : designTokens.colors[colorTokenReference + '/default'];
        return;
      }
...
const preset = {
  theme: {
    colors,
    borderRadius: Object.assign(Object.assign({}, designTokens.borderRadii), { none: '0px' }),
