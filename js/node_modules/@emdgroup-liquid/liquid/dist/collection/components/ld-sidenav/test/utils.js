...
export function getSidenavWithoutSubnavigation(options) {
  return `
    ${(options === null || options === void 0 ? void 0 : options.collapsible)
    ? '<ld-sidenav-toggle-outside></ld-sidenav-toggle-outside>'
    : ''}
    <ld-sidenav open${(options === null || options === void 0 ? void 0 : options.collapsible) ? ' collapsible' : ''}${(options === null || options === void 0 ? void 0 : options.collapsed) ? ' collapsed' : ''}${(options === null || options === void 0 ? void 0 : options.align) ? ' align="' + options.align + '"' : ''}>
...
export function getSidenavWithSubnavigation(options) {
  return `
    ...
    ? '<ld-sidenav-toggle-outside></ld-sidenav-toggle-outside>'
    : ''}
    <ld-sidenav open${(options === null || options === void 0 ? void 0 : options.collapsible) ? ' collapsible' : ''}${(options === null || options === void 0 ? void 0 : options.collapsed) ? ' collapsed' : ''}${(options === null || options === void 0 ? void 0 : options.narrow) ? ' narrow' : ''}${(options === null || options === void 0 ? void 0 : options.neutral) ? ' neutral' : ''}${(options === null || options === void 0 ? void 0 : options.align) ? ' align="' + options.align + '"' : ''}>
      <ld-sidenav-header href="#" slot="header">Computer Science</ld-sidenav-header>
      <ld-sidenav-back slot="top">
        <ld-sidenav-navitem ${(options === null || options === void 0 ? void 0 : options.roundedBackButton) ? ' rounded' : ''}>Outline of Computer Science</ld-sidenav-navitem>
      </ld-sidenav-back>
      <ld-sidenav-slider ${(options === null || options === void 0 ? void 0 : options.currentSubnav)
...
export function getSidenavWithAccordion(options) {
  const preserveAccordionStateProp = options.preserveAccordionState === undefined ||
